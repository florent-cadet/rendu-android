        ...
        public MovieViewHolder(final View v, final MovieActionInterface movieActionInterface) {
            ...
            movieWatchedButton.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    movieItemViewModel.setWatched(!movieItemViewModel.isWatched());
                    movieActionInterface.onWatchedButtonClicked(movieItemViewModel.getId(), movieItemViewModel.isWatched());
                    movieWatchedButton.setSelected(movieItemViewModel.isWatched());
                }
            });
        }
